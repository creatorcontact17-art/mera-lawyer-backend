...
app.get("/api", (req, res) => {
  res.status(200).json({
    ...
    endpoints: [
      ...
      { method: "GET", path: "/api/content/case-studies/categories" },
      { method: "GET", path: "/api/content/case-studies/category/:categoryId" },
      { method: "GET", path: "/api/content/case-studies/category/:categoryId/item/:caseStudyId" },
